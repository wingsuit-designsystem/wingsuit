...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2194)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/documentation/overview/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/documentation/overview/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/documentation/overview/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/documentation/overview/page",
        pathname: "/documentation/overview",
...
;// CONCATENATED MODULE: ./src/app/(docs)/documentation/overview/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            jsx_runtime_.jsx(_components.p, {
                children: "Storybook supports powerful MDX documentation out of the box.\nMDX is a standard file format that combines Markdown with JSX.\nWingsuit uses React components to render patterns and Twig files which you use direct inside the MDX file. Additionally, Wingsuit offers components to make documentation more easy."
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "And yes, storybook MDX is powerful, but in most cases you don't need it. Wingsuit uses the wingsuit.yml to generate an complete component documentation including fields, settings etc."
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To replace the automatic documentation you need add an ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "pattern.mdx"
                    }),
                    " file to your pattern and import this file into your story."
                ]
            }),
            "\n",
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    ...
                    " under your design system or under ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "apps/storybook/patterns"
                    }),
                    "."
                ]
            }),
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Disable documentation"
            }),
            "\n",
            jsx_runtime_.jsx(_components.pre, {
                children: jsx_runtime_.jsx(_components.code, {
...
;// CONCATENATED MODULE: ./src/app/(docs)/documentation/overview/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(50976)));
