...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 47067)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/presets/overview/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/presets/overview/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/presets/overview/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/presets/overview/page",
        pathname: "/presets/overview",
...
;// CONCATENATED MODULE: ./src/app/(docs)/presets/overview/index.mdx
        ...
        children: [
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    ...
                    " to make webpack configurations reusable across different apps."
                ]
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "The goal is to deliver a community-driven set of webpack presets. Check out the predefined presets in the ",
                    jsx_runtime_.jsx(_components.a, {
                        href: "@TODO",
                        children: "default config stub"
                    }),
                    "."
                ]
            }),
            ...
            jsx_runtime_.jsx(_components.h2, {
                children: "What is a preset"
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "A preset provides a pre configured webpack configuration bundled in a node module."
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    ...
                    jsx_runtime_.jsx(_components.a, {
                        href: "https://github.com/wingsuit-designsystem/wingsuit/blob/master/presets/scss/src/index.ts",
                        children: "wingsuit scss bundle"
                    }),
                    "."
                ]
            }),
            ...
            (0,jsx_runtime_.jsxs)(_components.ul, {
                children: [
                    ...
                    (0,jsx_runtime_.jsxs)(_components.li, {
                        children: [
                            jsx_runtime_.jsx(_components.code, {
                                children: "defaultConfiguration"
                            }),
                            " should return the configuration defaults. This configuration can be overwritten."
                        ]
                    }),
                    "\n",
                    (0,jsx_runtime_.jsxs)(_components.li, {
                        children: [
                            ...
                            " should return the webpack code"
                        ]
                    }),
                    "\n",
                    (0,jsx_runtime_.jsxs)(_components.li, {
                        children: [
                            ...
                            " is optional and should only be implemented if the preset needs to make changes to the final webpack."
                        ]
                    }),
                    "\n"
                ]
            ...
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Install a preset"
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To install a preset add your preset to your ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "package.json"
                    }),
                    " and add it to your ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "wingsuit.config.yml"
                    }),
                    ":"
                ]
            }),
...
/* harmony default export */ const overview = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/presets/overview/page.tsx
...
const metadata = {
    title: "Presets",
    description: "Wingsuit uses presets to make webpack configurations reusable across different apps."
};
function Page() {
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(83635)));
