...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 28487)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/presets/pwa/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/presets/pwa/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/presets/pwa/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/presets/pwa/page",
        pathname: "/presets/pwa",
...
;// CONCATENATED MODULE: ./src/app/(docs)/presets/pwa/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "Wingsuit also ships with a pwa preset, which uses ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "WebappWebpackPlugin"
                    }),
                    " under the hood to automatically generate all of your site favicons in multiple formats, as well as your webapp ",
                    jsx_runtime_.jsx(_components.code, {
            ...
            jsx_runtime_.jsx(_components.h2, {
                children: "Installing the pwa preset"
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To use this preset, firstly you install it as a dev-dependency via ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "yarn"
                    }),
                    "or ",
            ...
            jsx_runtime_.jsx(_components.pre, {
                children: jsx_runtime_.jsx(_components.code, {
                    ...
                    children: "yarn add @wingsuit-designsystem/preset-pwa -D\n"
                })
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "After that, you'll need wingsuit to consume the preset by loading it via your wingsuit.config.js:"
            }),
            "\n",
            jsx_runtime_.jsx(_components.pre, {
                children: jsx_runtime_.jsx(_components.code, {
                    className: "language-js",
                    children: "const namespaces = require('./source/default/namespaces');\n\nmodule.exports = {\n  presets: [\n    '@wingsuit-designsystem/preset-pwa',\n  ],\n  designSystems: {\n    default: {\n      namespaces,\n    },\n  },\n};\n"
                })
            }),
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Default behavior & customizations"
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "Out of the box the preset will generate multiple formats of your favicons and your ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "manifest.json"
                    }),
                    " ",
                    ...
                    " when running a production build of ",
                    jsx_runtime_.jsx("b", {
                        children: "drupal"
                    }),
                    ".\nIt will look for a ",
                    ...
                    " folder. The generated files will be placed into ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "/dist/[app]/favicons"
                    }),
                    " by default. You have, however, the possibility to modify all of this by using a special ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "pwa"
                    }),
                    " object within the ",
                    ...
                    " object in your ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "wingsuit.config.js"
                    }),
                    ".\nYou'll also want to define your project specific pwa values there, because their default value are set to ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "null"
                    }),
            ...
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Integration into your CMS"
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To integrate your favicon into your CMS copy the content of ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "app-TYPE/webapp.html"
                    }),
...
/* harmony default export */ const pwa = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/presets/pwa/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(84092)));
