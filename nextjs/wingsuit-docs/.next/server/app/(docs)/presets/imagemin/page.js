...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 36550)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/presets/imagemin/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/presets/imagemin/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/presets/imagemin/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/presets/imagemin/page",
        pathname: "/presets/imagemin",
...
;// CONCATENATED MODULE: ./src/app/(docs)/presets/imagemin/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            jsx_runtime_.jsx(_components.p, {
                children: "The official wingsuit imagemin preset optimizes your images and creates .webp variants of all JPEG and PNG files in your project."
            }),
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Installing the imagemin preset"
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "For most real-world projects, we recommend using this preset. In order to do so, you'll want to install the preset as a dev-dependency via ",
            ...
            jsx_runtime_.jsx(_components.pre, {
                children: jsx_runtime_.jsx(_components.code, {
                    ...
                    children: "yarn add @wingsuit-designsystem/preset-imagemin -D\n"
                })
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "By default, the imagemin preset takes care of all of your images, which are imported or targeted in your ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "apps/[app]/assets.js"
                    }),
                    " (.e.g.: ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "/source/default/***/**/images/*.{jpg|png}"
                    }),
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To deactivate the automatic webp creation, merely use the following exposed property within the parameters object of your ",
                    jsx_runtime_.jsx(_components.code, {
...
/* harmony default export */ const imagemin = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/presets/imagemin/page.tsx
...
function Page() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(imagemin, {}),
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(58097)));
