...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 87579)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/components/presentation/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/components/presentation/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/components/presentation/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/components/presentation/page",
        pathname: "/components/presentation",
...
;// CONCATENATED MODULE: ./src/app/(docs)/components/presentation/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "Presentation templates are located typically at ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "apps/storybook/patterns/type/"
                    }),
            ...
            "\n",
            jsx_runtime_.jsx("b", {
                children: "A Presentation component contains:"
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.ul, {
                children: [
                    ...
                    jsx_runtime_.jsx(_components.li, {
                        children: "pattern.stories.jsx"
                    }),
                    "\n",
                    jsx_runtime_.jsx(_components.li, {
                        children: "pattern.twig"
                    }),
                    "\n"
                ]
            }),
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "Within the stories, you load the twig file the same way as you do it in the ",
            ...
            (0,jsx_runtime_.jsxs)(_components.ul, {
                children: [
                    ...
                    (0,jsx_runtime_.jsxs)(_components.li, {
                        children: [
                            jsx_runtime_.jsx(_components.code, {
                                children: "pattern_preview(patternId, variantId, variables)"
                            }),
                            " to render an existing pattern, including all preview data from the component. You can overwrite preview data with variables."
                        ]
                    }),
                    "\n",
                    (0,jsx_runtime_.jsxs)(_components.li, {
                        children: [
                            jsx_runtime_.jsx(_components.code, {
                                children: "pattern(patternId, variantId, variables)"
                            }),
                            " to render a pattern without any preview data. You can provide all variables as the third argument."
                        ]
                    }),
                    "\n"
                ]
...
/* harmony default export */ const presentation = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/components/presentation/page.tsx
...
function Page() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(presentation, {}),
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(71540)));
