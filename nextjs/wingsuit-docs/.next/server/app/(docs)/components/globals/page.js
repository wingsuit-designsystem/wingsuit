...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 53573)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/components/globals/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/components/globals/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/components/globals/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/components/globals/page",
        pathname: "/components/globals",
...
;// CONCATENATED MODULE: ./src/app/(docs)/components/globals/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "If you need variables with global scope inside your twig template you can place a YAML file to ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "apps/storybook/config"
                    }),
                    "."
                ]
            }),
            ...
            jsx_runtime_.jsx(_components.p, {
                children: "You can access every variable directly in your twig template."
            }),
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Frontend metadata as global variables"
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To expose metadata from front-end frameworks to storybook webpack plugins you can generate JSON files and store them under ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "apps/storybook/config/silo"
                    }),
                    ". Wingsuit will automatically read these files and handle the content as global variables.\nWingsuit provides a plugin for tailwind metadata."
                ]
            })
        ]
    });
...
/* harmony default export */ const globals = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/components/globals/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(51350)));
