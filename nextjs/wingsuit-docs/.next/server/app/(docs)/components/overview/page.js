...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 59602)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/components/overview/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/components/overview/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/components/overview/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/components/overview/page",
...
;// CONCATENATED MODULE: ./src/app/(docs)/components/overview/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            jsx_runtime_.jsx(_components.p, {
                children: "The following component types are available with wingsuit:"
            }),
            "\n",
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "Use this component in most cases. Read ",
                ...
                children: [
                    ...
                    (0,jsx_runtime_.jsxs)(_components.li, {
                        children: [
                            "\n",
                            jsx_runtime_.jsx(_components.h3, {
                                children: "Wingsuit component with presentation template"
                            }),
                            "\n"
                        ]
                    }),
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "A component if you need an additional ",
                    jsx_runtime_.jsx(_components.a, {
                        href: "/components/presentation",
                        children: "presentation template"
                    }),
                    "."
                ]
            }),
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "Use ",
                    jsx_runtime_.jsx(_components.a, {
                        href: "/components/twig",
                        children: "Twig only"
                    }),
                    " if you have a very simple template without any data."
                ]
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.ul, {
                children: [
                    ...
                    (0,jsx_runtime_.jsxs)(_components.li, {
                        children: [
                            "\n",
                            jsx_runtime_.jsx(_components.h3, {
                                children: "Twig only component with presentation template"
                            }),
                            "\n"
                        ]
                    }),
            ...
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "The same as a Twig template with an additional presentation template."
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.ul, {
                children: [
            ...
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "A presentation template only. Choose this if you want to build a complete Page."
            })
        ]
    });
}
...
;// CONCATENATED MODULE: ./src/app/(docs)/components/overview/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(92601)));
