...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 28782)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/apps/drupal/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/apps/drupal/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/apps/drupal/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/apps/drupal/page",
        pathname: "/apps/drupal",
...
;// CONCATENATED MODULE: ./src/app/(docs)/apps/drupal/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            jsx_runtime_.jsx(_components.p, {
                children: "Wingsuit also ships with a drupal APP."
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    ...
                    jsx_runtime_.jsx(_components.code, {
                        children: "yarn ws dev drupal"
                    }),
                    " for dev mode or for build mode ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "yarn ws build drupal"
                    }),
                    "."
                ]
            }),
            ...
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Integrate into Drupal"
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "With the ",
                    jsx_runtime_.jsx(_components.a, {
                        href: "https://www.drupal.org/project/components",
                        children: "components"
                    }),
                    " module you can map namespace to the TWIG templates inside your dist folder."
                ]
            })
        ]
    });
...
/* harmony default export */ const drupal = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/apps/drupal/page.tsx
...
function Page() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(drupal, {}),
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(18758)));
