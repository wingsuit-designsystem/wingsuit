...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 99481)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/apps/overview/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/apps/overview/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/apps/overview/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/apps/overview/page",
        pathname: "/apps/overview",
...
;// CONCATENATED MODULE: ./src/app/(docs)/apps/overview/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            jsx_runtime_.jsx(_components.p, {
                children: "Wingsuit apps integrate your Design System into your application or CMS.\nRight now Wingsuit supports three app types."
            }),
            "\n",
            ...
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "To create a new app run:"
            }),
            "\n",
            ...
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Start an app"
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "To start an app in dev mode run"
            }),
            "\n",
            jsx_runtime_.jsx(_components.pre, {
                children: jsx_runtime_.jsx(_components.code, {
...
;// CONCATENATED MODULE: ./src/app/(docs)/apps/overview/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(75769)));
