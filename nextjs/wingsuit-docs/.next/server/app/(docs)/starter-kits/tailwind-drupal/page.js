...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 27421)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/starter-kits/tailwind-drupal/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/starter-kits/tailwind-drupal/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/starter-kits/tailwind-drupal/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/starter-kits/tailwind-drupal/page",
        pathname: "/starter-kits/tailwind-drupal",
...
;// CONCATENATED MODULE: ./src/app/(docs)/starter-kits/tailwind-drupal/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            jsx_runtime_.jsx(_components.h1, {
                children: "Drupal loves TailwindCSS"
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "The Tailwind starter kit the quickest way to get up and running with Wingsuit."
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "TailwindCSS and Drupal is great team if you structure your templates component based.\nOne TWIG template must be the single point of truth otherwise TailwindCSS is not maintainable."
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "Drupal out of the box provides templates for each form / element /etc. We need a mechanisms to map\nthese templates to components. In Drupal there are two possibilities. Presenter templates or the UI Patterns\necosystems. UI Patterns is a no code solution to map entities to Patterns."
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "The starter kit is using UI Patterns."
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "To use the tailwind starter kit standalone install it with:"
            }),
            "\n",
            jsx_runtime_.jsx(_components.pre, {
                children: jsx_runtime_.jsx(_components.code, {
                    children: "npx @wingsuit-designsystem/cli init -k tailwind\n"
                })
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To use the starter kit checkout the ",
                    jsx_runtime_.jsx(_components.a, {
                        href: "https://wingsuit-designsystem.github.io/drupal/ui_patterns/",
...
/* harmony default export */ const tailwind_drupal = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/starter-kits/tailwind-drupal/page.tsx
...
function Page() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(tailwind_drupal, {}),
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(12031)));
