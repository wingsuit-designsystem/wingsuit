...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 49125)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/guides/showroom/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/guides/showroom/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/guides/showroom/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/guides/showroom/page",
        pathname: "/guides/showroom",
...
;// CONCATENATED MODULE: ./src/app/(docs)/guides/showroom/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            jsx_runtime_.jsx(_components.p, {
                children: "Storybook patterns overwhelm most customer. To provide only the patterns the customer needs Wingsuit (>=1.2)\nadds a showroom feature."
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To configure the structure of Wingsuit adds a alterStory and alterPattern hook. Open ",
            ...
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "Here a sample for a Drupal Layout Builder centric project."
            }),
            "\n",
            ...
            jsx_runtime_.jsx(_components.h2, {
                children: "Start storybook in showroom mode"
            }),
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "Run either"
            ...
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "to start storybook in dev mode."
            })
        ]
    });
}
...
/* harmony default export */ const showroom = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/guides/showroom/page.tsx
...
function Page() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(showroom, {}),
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(82921)));
