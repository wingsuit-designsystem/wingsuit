...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 94848)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/guides/create-app-guide/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/guides/create-app-guide/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/guides/create-app-guide/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/guides/create-app-guide/page",
        pathname: "/guides/create-app-guide",
...
;// CONCATENATED MODULE: ./src/app/(docs)/guides/create-app-guide/index.mdx
...
function _createMdxContent(props) {
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            "\n",
            jsx_runtime_.jsx(_components.p, {
                children: "The wizard will ask you for the app type and the path to the app."
            })
        ]
    });
}
...
/* harmony default export */ const create_app_guide = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/guides/create-app-guide/page.tsx
...
function Page() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(create_app_guide, {}),
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(93852)));
