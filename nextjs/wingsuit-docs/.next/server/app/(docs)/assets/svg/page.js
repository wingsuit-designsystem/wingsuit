...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 64606)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/assets/svg/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/assets/svg/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/assets/svg/page";
const __next_app__ = {
...
;// CONCATENATED MODULE: ./src/app/(docs)/assets/svg/index.mdx
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "If you need SVG files as images instead of icons, put your images in an ",
            ...
            jsx_runtime_.jsx(_components.pre, {
                children: jsx_runtime_.jsx(_components.code, {
                    ...
                    children: "<img src=\"{{ file_create_url('ws-assets://images/icon.svg')\">\n"
                })
            }),
            "\n",
            jsx_runtime_.jsx(_components.h2, {
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "Wingsuit generates an SVG sprite map for every SVG located in an ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "icons"
                    }),
                    " folder."
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "To render the icons include the ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "svg atom"
                    }),
            ...
            jsx_runtime_.jsx(_components.pre, {
                children: jsx_runtime_.jsx(_components.code, {
                    className: "language-twig",
                    children: '{% include "@atoms/svg/svg.twig" with {"variant": \'icon\', icon: "icon" }\n'
                })
            }),
            "\n",
            jsx_runtime_.jsx(_components.h2, {
                children: "Multiple SVG spritemaps."
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "If you need more than one spritemap you can put your icons in a separate folder and extend the preset configuration in ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "wingsuit.yml"
                    }),
                    ".\nFor example, if you need a spritemap for your language icons, put all the icons in a folder called ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "icons-languages"
                    }),
                    ".\nThen you need to configure the ",
                    jsx_runtime_.jsx(_components.a, {
                        href: "https://github.com/wingsuit-designsystem/wingsuit/blob/master/packages/core/src/server/presets/svg.ts",
                        children: "svg preset"
                    }),
                    " with multiple svg folders."
                ]
            }),
            "\n",
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "Here's the configuration for our ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "icons-languages"
                    }),
                    " example:"
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "After that you need to adjust the ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "icons.mdx"
                    }),
...
/* harmony default export */ const svg = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/assets/svg/page.tsx
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(72238)));
