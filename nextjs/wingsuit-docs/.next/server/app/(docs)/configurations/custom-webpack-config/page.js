...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 35980)), "/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/configurations/custom-webpack-config/page.tsx"],
...
const pages = ["/home/michaelzemui/projects/wingsuit/wingsuit/nextjs/wingsuit-docs/src/app/(docs)/configurations/custom-webpack-config/page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(docs)/configurations/custom-webpack-config/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(docs)/configurations/custom-webpack-config/page",
        pathname: "/configurations/custom-webpack-config",
...
;// CONCATENATED MODULE: ./src/app/(docs)/configurations/custom-webpack-config/index.mdx
...
function _createMdxContent(props) {
    ...
    return (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            ...
            (0,jsx_runtime_.jsxs)(_components.p, {
                children: [
                    "If you want to alter the final config, use the ",
                    jsx_runtime_.jsx(_components.code, {
                        children: "webpackFinal hook"
                    }),
                    ":"
                ]
            }),
...
/* harmony default export */ const custom_webpack_config = (MDXContent);
...
;// CONCATENATED MODULE: ./src/app/(docs)/configurations/custom-webpack-config/page.tsx
...
function Page() {
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx(custom_webpack_config, {}),
...
var __webpack_exports__ = __webpack_require__.X(0, [730,153,707,246], () => (__webpack_exec__(63418)));
