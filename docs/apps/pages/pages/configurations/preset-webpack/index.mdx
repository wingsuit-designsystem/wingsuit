...
* `defaultConfiguration` should return the configuration defaults. This configuration can be overwritten.
...
## Configure a preset
Each preset should work with zero configuration out of the box. A preset ships with default configuration defined by the defaultConfiguration method.
