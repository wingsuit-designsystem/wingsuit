...
<div className="next">
    ...
    <a className="next__button mb-2 btn btn-lg bg-green-500 mr-2 font-weight-bold" target="_blank" href="https://github.com/wingsuit-designsystem/wingsuit/issues">Issue</a>
</div>
<div className="next">
...
<div className="next">
    <div className="next__content"><b>Quickstart guide</b></div>
    <a className="next__button mb-2 btn btn-lg bg-green-500 mr-2 font-weight-bold" href="../../guides/quick-start-guide">Continue</a>
</div>
<div className="next">
...
<div className="caption">Edit settings with Knobs</div>

<img src="/images/docs.png"/>
<div className="caption">Automatic generated Docs</div>

### Drupal

<img src="/images/configure-patterns.png"/>
<div className="caption">Map fields and configure your pattern in Manage Display with Layout builder.</div>

<img src="/images/add-blocks.png"/>
<div className="caption">Use the mapped pattern as inline block in Layout tab</div>
